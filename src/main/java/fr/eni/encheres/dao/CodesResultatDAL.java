...
public abstract class CodesResultatDAL {
	 ...
	 */
	public static final int SUPRESSION_ARTICLE_ERREUR=10005;
	
	/**
	 * Echec à la suppression d'une liste
	 */
	public static final int SUPRESSION_LISTE_ERREUR=10006;
	...
	/**
	 * Erreur au cochage de tous les articles d'une liste
	 */
