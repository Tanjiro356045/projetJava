<%@page import="fr.eni.encheres.bll.ManagerUtilisateur"%>
...
<!DOCTYPE html>
    ...
    <section class="profile">
        ...
        <tr>
            ...
            <%if(userAffiche.getNoTelephone()!=null) {%>

            <td class="td2"><p class="value-td2"><%=userAffiche.getNoTelephone() %></td>
    ...
    <% if(connectedUser.getNoUtilisateur()==userAffiche.getNoUtilisateur() ){%>
